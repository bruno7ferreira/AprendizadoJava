...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int opcao = obterOpcaoMenu(entrada);
        while (opcao != 0) {
    ...
    private static void consultarLista(ArrayList<Contato> lista) {
        for (Contato cont : lista) {
            System.out.println(cont);
        }
    }

    private static void excluirTudo(ArrayList<Contato> lista) {
        lista.clear();
    ...
    private static void obterPosicao(Scanner entrada, ArrayList<Contato> lista) {
    ...
    protected static int obterOpcaoMenu(Scanner entrada) {
        ...
        while (!entradaValida) {
            ...
            try {
                ...
                System.out.println("Entrada inválidam digite novamente!\n\n");
            }
        }
